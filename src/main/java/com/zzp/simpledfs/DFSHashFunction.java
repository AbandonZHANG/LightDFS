...
public class DFSHashFunction {
    ...
    public static LongPair hash(String key) {
        byte[] keyByte = key.getBytes();
        LongPair longPair = new LongPair();
        murmurhash3_x64_128(keyByte, 0, keyByte.length, 0, longPair);
        return longPair;
    }
    public static LongPair hash(byte[] key) {
        LongPair longPair = new LongPair();
        murmurhash3_x64_128(key, 0, key.length, 0, longPair);
        return longPair;
    }
    /**
